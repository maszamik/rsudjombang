    ...
    <div class="app">
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Informasi</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                <a href="home.php" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                                <a class="breadcrumb-item" href="#">Informasi</a>
                                <span class="breadcrumb-item active">Poli & Dokter</span>
                            </nav>
                        </div>
                    </div>
                   <!-- Begin Page Content -->
                    ...
                    <div class="row">
                          ...
                          <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-list"></i>  List Dokter</h6>
							                  ...
							                  <div class="form-group">
							                   ...
							                   <div class="form-group">
								                  ...
								                  <select class="form-control" id="nama_poli" name="nama_poli">
									                <option value="0">Pilih Poli Dahulu</option>
								                  </select>
							                </div>
						                  </form>
		...
		$(document).ready(function() {
		    $("#kategori").change(function() {
		        ...
		        $.ajax({
			        url: 'https://mikhosted.my.id/sistemmik/service.php',
			...
			$("#nama_poli").change(function() {
			    ...
			    $.ajax({
			        url: 'https://mikhosted.my.id/sistemmik/service-list.php',
			        data  : 'kategori=' +kategori + '&nama_poli=' + nama_poli,
			        type: 'POST',
			        dataType: 'html',
			        success: function(msg) {
				        $("#nama_dokter").html(msg);
			        }
		        });
	        });
		});
