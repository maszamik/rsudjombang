              ...
              <div class="card">
                <div class="card-body">
                  <div id="invoice" class="p-h-30">
                    <?php
                      $result = $koneksi -> query("SELECT * FROM reservasi JOIN transaksi ON reservasi.reservasi_id = transaksi.reservasi_id WHERE transaksi_id = '$transaksi_id';");
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            if($row['keterangan'] == "Sesi Konsultasi"){
                              ...
                              ?>
                              <?php
                                $hargaobat = $koneksi -> query("SELECT * FROM resep_obat JOIN obat ON resep_obat.obat_id = obat.obat_id WHERE transaksi_id = '$transaksi_id';");
