    ...
    include '../../koneksi.php';
          ...
          if (isset($_POST['ganti_password'])) {
            ...
            if (empty($confirmpassword)) {
		        ...
		        $error_log = '*Konfirmasi Kata Sandi Baru Tidak Sesuai.';
            } else {

            if ($cek_passwordnya <> $data_user['oldpassword']) {
                $error_log = 'Ups, Kata Sandi Lama Yang Kamu Masukkan Tidak Sesuai.';
            } else {

   		    if ($conn->query("UPDATE user SET password = '$newpassword' WHERE username = '$username'") == true) {
   			    $error_log = 'Kata Sandi Kamu Berhasil Diubah.';
                $error_type = 'success';
            } else {
   			    $error_log = 'Ups, Gagal! Sistem Kami Sedang Mengalami Gangguan.';
   		    }
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <button type="submit" name="ganti_password" class="btn btn-primary m-t-30">Change</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
