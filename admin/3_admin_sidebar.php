                    ...
                    <ul class="side-nav-menu scrollable">
						...
						<li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="admin_table.php">List User</a>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!-- <li>
                                    <a href="admin_invoice_template.php">Invoice Template</a>
                                </li> -->
                            </ul>
                        </li>
                        <!-- <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="avatar.php">Layanan</a>
                                </li>
                                <li>
                                    <a href="alert.php">Cara Penggunaan</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="accordion.php">E-Resep</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="form-elements.php">Konsultasi</a>
                                </li>
                                <li>
                                    <a href="form-layouts.php">Transaksi</a>
                                </li>
                            </ul>
                        </li> -->
                    </ul>
