...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/images/logo-rs-kecil.png" />
        ...
        <div class="header">
          <div class="logo logo-dark">
            <a href="">
              ...
              <img
                class="logo-fold"
                src="assets/images/logo-rs-kecil.png"
                alt="Logo"
                  ...
                  <div id="invoice" class="p-h-30">
                    <?php
                      $result = $conn -> query("SELECT * FROM reservasi 
                                                ...
                                                JOIN transaksi ON reservasi.reservasi_id = transaksi.reservasi_id WHERE transaksi_id = '$transaksi_id';");
                            ...
                            if($row['keterangan'] == "Sesi Konsultasi"){
                              ...
                              ?>
                                <tr>
                                  ...
                                  $total_semua = $total_satuan + $biaya_pengiriman;
                                  echo $total_satuan; ?>
                                  </td>
                                </tr>
                              <?php
                      ...
                      <div class="row m-t-30 lh-1-8">
                        <div class="col-sm-12">
                          <div class="float-right text-right">
                            <p>Sub - Total harga: Rp <?php echo $total_satuan; ?></p>
                            <p>Biaya Pengiriman : Rp <?php echo $biaya_pengiriman; ?></p>
                            <hr />
                            <h3>
                              <span class="font-weight-semibold text-dark">
                                Total : Rp
                              </span>
                              <?php echo $total_semua; ?>
                            </h3>
                          </div>
                        </div>
                      </div>
