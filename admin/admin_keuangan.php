                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                ...
                                ?>
                            <form class="form-inline" method="post" action="admin_pdf_transaksi.php">
                                <button action="admin_pdf_transaksi.php" type="submit" id="pdf" name="generate_pdf" class="btn btn-primary"><i class="fa fa-pdf" aria-hidden="true"></i>Generate PDF</button>
                            </form>
                            </div>
                        </div>
                    </div>
